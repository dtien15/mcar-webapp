<?php
/**
 * Partial: toan bo phan "noi dung" cua trang Bang luong (canh bao ty gia, o
 * thong ke, luoi the tai xe, cac modal Thanh toan) - KHONG gom form loc/nut
 * tinh lai o tren. Dung chung giua lan tai trang dau (danhsach.php) va API
 * realtime soLieuMoi() de khong lap logic render 2 noi.
 * Nhan vao: $thang, $nam, $bangLuong, $coCanhBaoTyGia
 */
